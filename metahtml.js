...
module.exports = {
  ...
  html : '<head><meta charset="UTF-8"><title>Blaze</title><meta name=viewport content="width=device-width, initial-scale=1"><meta name="description" content="' + MetaDescriptionPlaceholder + '"><meta property="og:title" content="' + MetaTitlePlaceholder + '"><meta property="og:url" content="' + URLPlaceholder + '" /><meta property="og:description" content="' + MetaDescriptionPlaceholder + '"><meta property="og:image" itemprop="image" content="' + MetaImageURLPlaceholder + '"><meta name="twitter:card" content="summary_large_image"/><meta name="twitter:title" content="' + MetaTitlePlaceholder + '"/><meta name="twitter:description" content="' + MetaDescriptionPlaceholder + '"/><meta name="twitter:image" content="' + MetaImageURLPlaceholder + '"/><meta http-equiv="refresh" content="0; url=' + URLPlaceholder + '" /></head>'
};
